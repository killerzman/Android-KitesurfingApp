...
public class APIEndpoints {
    ...
    final public static String addFavoriteSpot = "https://internship-2019.herokuapp.com/api-spot-favorites-add";
    final public static String removeFavoriteSpot = "https://internship-2019.herokuapp.com/api-spot-favorites-remove";
}
